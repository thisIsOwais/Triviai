...
//     // Show options for starting quiz or viewing leaderboard
//     const action = confirm(
//       `Start "${quizCategories.find((c) => c.id === categoryId)?.title}" quiz?\n\nClick OK to start quiz, Cancel to view leaderboard`,
//     )

//     if (action) {
//       alert(`Demo: Starting quiz for category ${categoryId}. Add routing to /quiz/${categoryId} when ready.`)
//     } else {
//       alert(
//         `Demo: Viewing leaderboard for category ${categoryId}. Add routing to /quiz/${categoryId}/leaderboard when ready.`,
//       )
//     }
//   }
