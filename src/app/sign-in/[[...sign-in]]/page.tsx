...
import { Brain, Mail, Lock, Eye, EyeOff, Moon, Sun } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">Sign in to continue your quiz journey</p>
          </div>
          ...
          <Card className="glass-effect border-0 shadow-xl">
            ...
            <CardContent>
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <Button type="submit" className="w-full gradient-violet text-white border-0 hover:opacity-90">
                  Sign In
                </Button>
              </form>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  {/* <Button variant="outline" onClick={() => handleSocialSignIn("oauth_google")}> */}
                  ...
                  {/* <Button variant="outline" onClick={() => handleSocialSignIn("oauth_github")}> */}
                    <Button variant="outline" onClick={() =>signInWith('oauth_github')}>
