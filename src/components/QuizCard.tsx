...
import { Play, Users, Clock, Target } from "lucide-react"
...
export function QuizCard({ quiz, onStartQuiz, className = "" }: QuizCardProps) {
  ...
  return (
    <Card
      className={`glass-effect border-0 hover:shadow-xl transition-all duration-300 cursor-pointer group ${className}`}
    >
      <CardHeader>
